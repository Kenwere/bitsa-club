    ...
    <style>
        ...
        * {
        ...
        .register-card {
            ...
            overflow-y: auto; /* Enable scrolling for card */
        }
...
<body>
    ...
    (function() {
        emailjs.init("kBkG6pOzC0cI4zDFL"); // Replace with your actual EmailJS public key
    ...
    async function sendVerificationCode() {
        ...
        try {
            ...
            // Send email using EmailJS - Using your template data
            const templateParams = {
                email: email,
                passcode: verificationCode,
                time: timeString,
                company_name: 'Bitsa Club',
            ...
            const response = await emailjs.send(
                'service_0wpy66l', // Replace with your EmailJS service ID
                'template_hw7kr58', // Replace with your EmailJS template ID
                templateParams
            );
            ...
            alert('Failed to send verification code. Please try again. Error: ' + error.text);
            sendCodeBtn.disabled = false;
    ...
    function verifyCode() {
        const enteredCode = document.getElementById('verification_code_input').value.trim();
